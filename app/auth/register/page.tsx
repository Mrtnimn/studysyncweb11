...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      if (!role) {
        ...
        toast({
          title: "Role Required",
          description: "Please select whether you're a student or teacher",
          variant: "destructive",
        })
        setLoading(false)
        return
      ...
      if (data?.session) {
        ...
        const redirectUrl = role === 'student' ? '/student' : '/teacher'
        setTimeout(() => {
  ...
  const handleOAuthRegister = async (provider: 'google' | 'github') => {
    try {
      ...
      toast({
        title: "Error",
        description: error?.message || 'Failed to connect with OAuth provider',
        variant: "destructive",
      })
    }
  }
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="teacher">
                      <div className="flex items-center gap-2">
                        ...
                        <span>Teacher - I want to teach</span>
                      </div>
                    </SelectItem>
                  </SelectContent>
                </Select>
